defmodule Skillchecker.Static do
  @moduledoc """
  The Static context.
  """
  ...
  @doc """
  Returns the list of static_items.

  ## Examples

      iex> list_static_items()
      [%Item{}, ...]

  """
  def list_static_items do
    Repo.all(Item)
  end
  ...
  ## Examples
      ...
      iex> list_static_groups()
      [%Group{}, ...]

  """
  def list_static_groups do
    Repo.all(Group)
  end
