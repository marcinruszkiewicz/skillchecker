defmodule SkillcheckerWeb.AdminAuth do
  ...
  def log_out_admin(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      SkillcheckerWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_admin:
      ...
      defmodule SkillcheckerWeb.PageLive do
        use SkillcheckerWeb, :live_view

        on_mount {SkillcheckerWeb.AdminAuth, :mount_current_admin}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{SkillcheckerWeb.AdminAuth, :ensure_authenticated}] do
  ...
  defp signed_in_path(_conn), do: ~p"/admins"
end
