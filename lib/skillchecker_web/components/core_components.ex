defmodule SkillcheckerWeb.CoreComponents do
  @moduledoc """
  ...
  attr :rest, :global, include: ~w(disabled form name value @click)
  ...
  def button(assigns) do
    ...
    <button
      ...
      class={[
        ...
        "text-sm font-semibold leading-6 text-white active:text-black/80 dark:bg-sky-300 dark:hover:bg-sky-600",
        @class
      ]}
      {@rest}
    >
      ...
      <table class="min-w-full align-middle text-sm dark:border-sky-800">
        ...
        <tbody id={@id} phx-update={match?(%Phoenix.LiveView.LiveStream{}, @rows) && "stream"}>
          ...
          >
            ...
            <td :if={@action != []} class="p-3 text-start font-semibold text-neutral-600">
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SkillcheckerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SkillcheckerWeb.Gettext, "errors", msg, opts)
    end
  end
