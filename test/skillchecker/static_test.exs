defmodule Skillchecker.StaticTest do
  ...
  describe "get_item_name/1" do
    test "returns name of the item if it exists" do
      insert(:item, name: "Cool Skill", eveid: 456)
  ...
  describe "get_group_name/1" do
    test "returns name of the item group if it exists" do
      insert(:group, name: "Our Skills", groupid: 4323)
      insert(:item, name: "Cool Skill", eveid: 456, groupid: 4323)
  ...
  describe "get_skill_multiplier/1" do
    test "returns multiplier if skill present" do
      insert(:item, name: "Cool Skill", eveid: 456, skill_multiplier: 12)
  ...
  describe "list_static_items/0" do
    test "returns all items" do
      s1 = insert(:item, name: "Cool Skill 1", eveid: 1)
      s2 = insert(:item, name: "Cool Skill 2", eveid: 2)
      s3 = insert(:item, name: "Cool Skill 3", eveid: 3)
  ...
  describe "list_static_groups/0" do
    test "returns all groups" do
      s1 = insert(:group, name: "Cool Skill 1", groupid: 1)
      s2 = insert(:group, name: "Cool Skill 2", groupid: 2)
      s3 = insert(:group, name: "Cool Skill 3", groupid: 3)
