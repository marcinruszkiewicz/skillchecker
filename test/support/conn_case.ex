defmodule SkillcheckerWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use SkillcheckerWeb.ConnCase, async: true`, although
  ...
  def log_in_admin(conn, admin) do
    token = Skillchecker.Accounts.generate_admin_session_token(admin)
